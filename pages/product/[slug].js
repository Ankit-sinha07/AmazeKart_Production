          ...
          <span className="flex ml-3 pl-3 py-2 border-l-2 border-gray-800 text-gray-500 space-x-2">
            ...
            <a>
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    <select className="rounded border border-gray-700 focus:ring-2 focus:ring-green-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-green-500 text-white pl-3 pr-10">
                      ...
                      <option className="text-black">XXL</option>
                    </select>
              ...
              <div className="flex">
                ...
                <button  onClick={() => {addToCart(slug, 1, product.price, product.title, product.size);}}
                  className="flex ml-2 text-white bg-green-500 border-0 py-2 px-2  md:px-6 focus:outline-none hover:bg-green-600 rounded"
                >
                  Add to cart
                </button>
                <button onClick={() => {buyNow(slug, 1, product.price, product.title, product.size);}}
                  className="flex ml-2 text-white bg-green-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-green-600 rounded">
                  Buy Now
                </button>
                <button className="rounded-full w-10 h-10 bg-gray-800 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4 hover:bg-red-300  hover:text-red-500">
                  <svg
                    fill="currentColor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                <input
                  ...
                  type="text"
                  className="px-2 border-2 border-blue-900 rounded-md"
                />
                <button
                  onClick={checkServiceability}
                  className="text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded-md"
                >
                  Check
                </button>
              </div>
              ...
              {service && service != null && (
                <div className="text-green-400 text-sm mt-3">
                  YAAAY! We deliver to this pincode :)
                </div>
              )}
            </div>
          </div>
...
//server side props or functions
